...
import { MobileCanvas } from '@/app/(landing-page)/_components/client-page/components/canvas/mobile';
import { MobileFooter } from '@/app/(landing-page)/_components/client-page/components/footer/mobile';
