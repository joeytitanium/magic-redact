    ...
    <>
      <Container size="lg" py="xl">
        <Stack gap="xl">
          ...
          {/* Free Trial */}
          {/* <Title order={2}>Free Trial</Title>
        <Text>
          MagicRedact may, at its sole discretion, offer a Subscription with a Free Trial for a
          limited period ("Free Trial"). You may be required to enter billing information to sign up
          for the Free Trial.
        </Text>
        <Text>
          If you provide your billing information when signing up for the Free Trial, you will not
          be charged until the Free Trial period ends. On the final day of the Free Trial, unless
          you cancel your Subscription, you will automatically be charged the applicable
          Subscription fees for the plan you selected.
        </Text>
        <Text>
          At any time and without notice, MagicRedact reserves the right to modify the Free Trial
          offer's terms and conditions or cancel the Free Trial offer altogether.
        </Text> */}
